...
class Orbit:
    ...
    def export(self):
        x = {'name': self.name,
             'semi major axis': str(self.semi_major_axis),
             'semi minor axis': str(round(self.semi_minor_axis, 3)),
             'eccentricity': str(self.eccentricity),
             'inclination': str(self.inclination),
             'periapsis': str(round(self.periapsis, 3)),
             'apoapsis': str(round(self.apoapsis, 3)),
             'orbital velocity': str(round(self.velocity, 3)),
             'orbital motion': str(self.motion),
             'orbital period': str(round(self.period, 3))
             }
        print(x)
        return x
